        ...
        ctx.logTaskCreation(
          {
            ...
            dueDateSource: taskMeta.dueDateSource,
            ...
            assigneeSource: taskMeta.assigneeSource,
            taskNumber: taskMeta.taskNumber,
            stageId: taskMeta.stageId,
            stageName: taskMeta.stageName,
            calendarEntryId: taskMeta.calendarEntryId,
          },
          response.data.data,
          Date.now() - start,
          'success'
