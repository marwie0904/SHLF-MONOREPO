...
const OLD_WEBHOOK_ID = 3184208;

async function recreateDocumentWebhook() {
  console.log('🔧 Recreating document webhook...\n');
  ...
  console.log('🔧 Creating new document webhook...');

  const webhookConfig = {
    url: WEBHOOK_URL,
    model: 'document',
    events: ['created'],
    fields: 'id,created_at,matter,name',
  };
